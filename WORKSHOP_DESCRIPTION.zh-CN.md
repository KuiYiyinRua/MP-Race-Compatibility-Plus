...
- 战斗速度解锁：联机时取消战斗、威胁事件强制降至 1 倍速，仍遵循 Multiplayer 的统一速度控制。
- TPS 优化设置：提供多档优化预设，可调整优化强度及相关参数。
- 多地图调度：提供按战斗、警戒与空闲状态分配更新频率的实验性调度，减少多基地同时更新的开销；默认关闭，需手动开启。
- 界面与日志减负：降低部分警报的重复检查频率，合并部分重复 UI 操作，并减少重复卡顿日志。
