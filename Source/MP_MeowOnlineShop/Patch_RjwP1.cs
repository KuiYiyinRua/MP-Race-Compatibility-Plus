...
namespace MP_MeowOnlineShop
{
    ...
    internal static class Patch_RjwP1
    {
        ...
        private static void PatchMenstruationResources(Harmony harmony)
        {
            ...
            _menstruationChooseOneResource = resourceHelpers == null
                ? null
                : AccessTools.Method(
                    resourceHelpers,
                    "ChooseOneResource",
                    new[] { AccessTools.TypeByName(
                        "RJW_Menstruation_Resources.HybridExtension") });
        ...
        private static bool UapGenitalCachePrefix(Pawn p, ref bool __result)
        {
            ...
            try
            {
                __result = (bool)_rjwHasPenis.Invoke(null, new object[] { p });
            }
            catch
            {
